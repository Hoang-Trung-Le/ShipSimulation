...
Ship = PlaceObj('Ship_7.ply') %place the ship model



if dualpods == false
    Pod = PlaceObj('Pod_3.ply')   %place the propeller model (size is exaggerated for visibility)
    ...
    Pod1 = PlaceObj('Pod_3.ply')   %place and offset the twin propeller models
    Pod2 = PlaceObj('Pod_3.ply')
